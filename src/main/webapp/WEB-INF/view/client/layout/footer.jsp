                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a target="_blank">
                                ...
                                <p class="text-secondary mb-0 " style="margin-top: 10px; ">@Hstore</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6" style="color: white;">
                        <div class="footer-item">
                            ...
                            <p>Author: Tran Huu Son</p>
                            <p>Website: <a target="_blank"> Hstore.vn</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a target="_blank"><i class="fas fa-copyright text-light me-2"></i>Huu
                                Son</a>, All right
                            reserved.</span>
                    </div>
